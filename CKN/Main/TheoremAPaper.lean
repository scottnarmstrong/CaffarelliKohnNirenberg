...
/-- The quantitative small-data regularity theorem, under the suitable
weak-solution class of `def:sws`. -/
theorem epsilonRegularityL3Paper (q : ℝ) (hq : 5 / 2 < q) :
...
by
  exact CKN.epsilonRegularityL3_paper q hq
