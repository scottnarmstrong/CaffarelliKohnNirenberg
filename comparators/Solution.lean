...
stated using Mathlib alone. Each selected theorem is proved directly from the CKN library. This module
repeats the Challenge definitions without importing its placeholder proofs;
Comparator checks their full statement dependency closures.
-/
    ...
    ∃ ε₁ : ℝ, 0 < ε₁ ∧
      ∀ (Ω : Set Vec3) (I : Set ℝ) (u : ParabolicPoint → Vec3)
        ...
        ∀ z₀ ∈ spaceTimeSet Ω I,
          ...
          IsRegularPoint Ω I u z₀ :=
  CKN.epsilonRegularityGradient q hq
...
theorem caffarelliKohnNirenberg (q : ℝ) (hq : 5 / 2 < q) :
  ...
  CKN.caffarelliKohnNirenberg q hq
